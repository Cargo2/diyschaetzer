...
@Component({
  selector: 'app-wizard',
  standalone: true,
  imports: [CommonModule, FormsModule, SummaryAssumptionsComponent],
...
export class WizardComponent {
  ...
  readonly roomTypeOptions: CardOption<RoomType>[] = [
  ...
  readonly sinkOptions: CardOption<SinkOption>[] = [
    {
      value: 'single_vanity',
  ...
  readonly vanityCabinetOptions: CardOption<VanityCabinetOption>[] = [
    {
      value: 'yes',
      title: 'Ja',
  ...
  readonly showerBathOptions: CardOption<ShowerBathOption>[] = [
    {
      value: 'shower_only',
      title: 'Nur Dusche',
  ...
  readonly showerTypeOptions: CardOption<ShowerType>[] = [
    {
  ...
  readonly bathtubTypeOptions: CardOption<BathtubType>[] = [
    {
      value: 'standard',
  ...
  readonly heatingOptions: CardOption<HeatingOption>[] = [
    {
      value: 'floor_heating',
  ...
  readonly toiletOptions: CardOption<ToiletOption>[] = [
    {
      value: 'wall_hung',
      title: 'Wand-WC',
  ...
  readonly tilingOptions: CardOption<TilingScope>[] = [
    {
      value: 'floor_only',
      title: 'Nur Boden',
  ...
  readonly tileQualityOptions: CardOption<TileQuality>[] = [
    {
      value: 'budget',
  ...
  readonly tileSizeOptions: CardOption<TileSize>[] = [
    {
      value: '30x30_cm',
      title: '30 x 30 cm',
  ...
  readonly extrasSelectionOptions: CardOption<ExtrasSelection>[] = [
    {
      value: 'selected',
  ...
  readonly extraOptions: CardOption<keyof BathroomExtras>[] = [
    {
      value: 'newLighting',
  ...
  readonly existingCoveringOptions: CardOption<ExistingCoveringLocation>[] = [
  ...
  readonly workStatusOptions: CardOption<WorkStatus>[] = [
  ...
  readonly substrateOptions: CardOption<SubstrateCondition>[] = [
  ...
  readonly scopeOptions: Array<{ key: keyof ScopeData; title: string; description: string }> = [
  ...
  validationMessage(): string {
    switch (this.currentStep().id) {
      case 'project-type':
        return 'Bitte wähle einen Raumtyp und gib einen Raumnamen ein.';
      case 'bathroom-size':
        return 'Bitte wähle eine Raumgröße zwischen 1,0 und 100,0 m².';
      case 'sink':
        return 'Bitte entscheide dich für eine Waschplatz-Lösung.';
      case 'shower-bath':
        return 'Bitte wähle eine Option für Dusche und Badewanne.';
      case 'heating':
        return 'Bitte wähle eine Heizlösung aus.';
      case 'toilet':
        return 'Bitte wähle eine WC-Option aus.';
      case 'tiling':
        return 'Bitte wähle Fliesenumfang, Fliesenqualität und Fliesengröße aus.';
      case 'walls':
        return 'Bitte wähle die Wand-Fliesengröße und prüfe die Wandangaben.';
      case 'preparation':
        return 'Bitte beantworte die sichtbaren Fragen zu Vorarbeiten und Untergrund. "Unklar" ist erlaubt.';
      case 'extras':
        return 'Bitte wähle Extras aus oder markiere den Bereich als keine Zusatzleistung oder noch unklar.';
      default:
        return '';
    }
  }
